...
function parseTeams(gamecode: string) {
  ...
  return {
    away,
    home,
    awayFull: TEAM_INFO[away] ? `${TEAM_INFO[away].city} ${TEAM_INFO[away].name}` : away,
    homeFull: TEAM_INFO[home] ? `${TEAM_INFO[home].city} ${TEAM_INFO[home].name}` : home,
  };
}
  ...
  return (
    <div className="games-page">
      <div className="games-header">
        ...
        <p className="games-count">{games.length} game{games.length !== 1 ? 's' : ''} scheduled</p>
      </div>
